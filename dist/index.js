...
const vectorSource = new VectorSource({
    ...
    attributions: 'University of Leicester (commissioned by the ' +
...
const vector = new VectorLayer({
    ...
    style: function (feature) {
        ...
        (_a = style.getFill()) === null || _a === void 0 ? void 0 : _a.setColor(color);
        return style;
    },
    opacity: 0.7,
});
